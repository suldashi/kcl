...
},{"./mediaelement/mediapipeline":9,"./mediaelement/playerendpoint":10,"./mediaelement/webrtcendpoint":11,"./message/messagefactory":12,"./message/responseadapter":13,"./ws/wschannel":15}],8:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
